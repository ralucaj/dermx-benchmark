...
from utils import train_model, unfreeze_layers, get_resnet_model, get_efficientnet_model, test_model, \
...
#     },
    {
        'model_name': 'inception_r20_s0.5_z0.5_b[0.5, 1.5]_lr0.001_lactivation_85',
...
for model_settings in models:
    for iteration in range(iterations):
        try:
            test_model(model_settings['base_path'], model_settings['model_name'] + f'_{iteration}',
